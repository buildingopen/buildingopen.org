      ...
      <div className="mx-auto max-w-2xl px-6">
        ...
        <section className="mb-10 text-zinc-400 space-y-6">
          <Figure
            ...
            alt="Japan trip planning with AI context"
            caption="Context transforms generic AI into a personalized advisor"
            priority
          />
          ...
          <h2 className="text-white font-semibold text-lg mt-8 mb-2">The power of context folders</h2>
          ...
          <PullQuote>
            AI without context gives you generic answers. AI with your context gives you your answers.
          </PullQuote>
          ...
          <Figure
            ...
            alt="10x Better Context visualization"
            caption="One command. Full context. Personalized answers."
          />
          ...
          <h2 className="text-white font-semibold text-lg mt-8 mb-2">Applying it to startups</h2>
          ...
          <h2 className="text-white font-semibold text-lg mt-8 mb-2">The learning happens along the way</h2>
          ...
          <Callout title="The principle">
            The difference is not the model. It is the input. Give any AI your context and it stops being a search bar and starts being an advisor.
          </Callout>
